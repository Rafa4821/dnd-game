      ...
      <div className="max-w-6xl w-full space-y-12 text-center relative z-10">
        ...
        <div className="space-y-6 perspective-1000">
          ...
          <div className="transform hover:scale-105 transition-transform duration-300">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight bg-gradient-to-b from-red-200 via-red-300 to-red-600 bg-clip-text text-transparent drop-shadow-2xl" style={{ textShadow: '0 0 40px rgba(239, 68, 68, 0.5)' }}>
              Sangrebruma
            </h1>
          </div>
          <p className="text-lg sm:text-xl md:text-2xl font-medium text-gray-200 drop-shadow-lg max-w-2xl mx-auto px-4">
        ...
        <div className="pt-8">
          <div className="relative inline-block group">
            ...
            <Link
              to="/auth"
              className="relative inline-flex items-center gap-2 sm:gap-3 px-8 sm:px-12 py-4 sm:py-5 bg-gradient-to-r from-red-600 to-rose-700 text-white font-bold text-base sm:text-lg rounded-xl hover:from-red-500 hover:to-rose-600 transition-all transform hover:scale-110 hover:shadow-2xl shadow-red-900/50 border-2 border-red-400/50"
            >
              <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 animate-pulse" />
              <span className="hidden sm:inline">Comenzar Aventura</span>
